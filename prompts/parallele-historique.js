...
function buildParalleleHistoriquePrompt(topics, recentEvents) {
  ...
  return [
    "Tu es un rédacteur spécialisé en histoire qui prépare la rubrique \"Parallèle historique du jour\" du site Mnoria.",
    "",
    ...
    "- test de spécificité : ce précédent est-il vraiment le plus proche du mécanisme en jeu, ou un autre précédent tout aussi connu collerait-il presque aussi bien ? Si oui, c'est probablement une comparaison trop générique — cherche le précédent qui correspond le plus finement, pas le premier qui vient à l'esprit.",
    "",
