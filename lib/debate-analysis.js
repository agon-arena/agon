...
- Argument qui confond deux notions importantes sans expliquer le mécanisme (ex. assimile vérification et censure sans démonstration) → total ≤ 65/100.
...
PLAFONDS PAR CRITÈRE pour un texte clair mais général (idée compréhensible, thèse lisible, mais sans développement réel des justifications) :
- Qualité du raisonnement (critère 3) ≤ 21/30.
- Précision / mécanisme concret (critère 4) ≤ 10/20.
- Nuance (critère 5) ≤ 5/10.
Ces plafonds par critère s'appliquent même si l'argument est bien rédigé, au ton modéré ou à la position présentée comme équilibrée.
