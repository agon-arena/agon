...
Si la contribution est une idée courte plutôt qu'un argument développé, évalue sa promesse argumentative : clarté, pertinence et potentiel de débat. Mais limite la note de raisonnement et de précision si le lien logique n'est pas explicité.

Ne pénalise pas automatiquement un argument court s'il est clair et pertinent.

En revanche, un argument très court ne doit normalement pas atteindre les notes maximales s'il ne développe pas de raisonnement, de mécanisme ou d'objection.
...
La nuance ne doit pas transformer le système en notation scolaire : une idée forte, claire et pertinente peut rester bien notée même si elle n'intègre pas beaucoup d'objections.
