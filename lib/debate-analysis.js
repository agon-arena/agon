...
const SCORING_RUBRIC_VERSION = 4; // v4 : PROMPT_AXIS sépare désormais un critère de couverture dédié (nombre d'éléments distincts attendus) des critères qualitatifs, pour éviter les notes de fond incohérentes entre contributions notées séparément
