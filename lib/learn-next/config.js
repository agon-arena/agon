...
// Appelé via fetchGpt5JsonContentWithRetry (server.js), qui envoie toujours
// reasoning_effort — donc un modèle de la famille gpt-5 est requis ici
// (jamais gpt-4.1-mini, qui rejette ce paramètre en HTTP 400 : bug constaté
// le 30/08/2026, l'appel IA n'a jamais réellement fonctionné avant ce
// correctif). Même choix que les autres tâches de classification légère du
// projet (cf. server.js OPINION_ARTICLE_CATEGORY_MODEL). Tarif réel
// disponible dans lib/ai-usage-log.js (MODEL_PRICING_USD_PER_MILLION_TOKENS).
const AI_FALLBACK_MODEL = process.env.OPENAI_LEARN_NEXT_FALLBACK_MODEL || "gpt-5-nano";
