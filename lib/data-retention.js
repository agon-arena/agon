...
// Purge abandonnée le 15/09/2026 ("il ne faut jamais purger les fiches et
// qcm") : une ligne daily_quiz purgée après 30 jours faisait perdre la fiche
// complète (sections/image) de toute notion Éclairages/culture générale hors
// "notion:%" mémorisée depuis plus longtemps — "Ma mémoire" (qui, elle,
// n'expire jamais) retombait alors pour toujours sur le repli tronqué à 2000
// caractères de user_article_acquisitions.eclairage_detail. Conservée
// uniquement pour compatibilité de signature ; plus aucun appel ne l'utilise
// ci-dessous.
...
module.exports = {
  ...
  getReferencedOpinionArticleIds,
