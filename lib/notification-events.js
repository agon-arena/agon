...
async function queueCommentNotificationEvents(supabase, {
  authorKey,
  argumentRow,
  parentCommentRow,
  argumentId,
  ...
  if (
    ...
    createdEvents.push(createNotificationEventSafe(supabase, {
  ...
  return (await Promise.all(createdEvents)).filter(Boolean);
}

module.exports = {
  queueCommentNotificationEvents,
  createNotificationEventSafe
};
