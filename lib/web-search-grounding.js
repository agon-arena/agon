...
// même contenu sous plusieurs URL), et c'est déjà la source explicitement
// PRIORITAIRE de tout ce pipeline (cf. referenceDomainRank ci-dessus,
// buildSourceSelectionPrompt) — laisser l'IA de sélection voir plusieurs
// pages Wikipédia candidates, plutôt que de lui en imposer une seule choisie
// arbitrairement par position, est directement dans l'esprit de ce
// pipeline. Le plafond global `maxCandidates` (8 par défaut) continue de
// borner la taille totale de la liste transmise à l'IA dans tous les cas.
