...
async function generate() {
  ...
  wrapTextCentered(ctx, normalizeText(question || "Débat sur agôn"), 600, 250, 920, 52);

  if (isOpen) {
    ctx.fillStyle = "#4b5563";
    ctx.font = "28px Arial";
    ctx.textAlign = "center";
    wrapTextCentered(ctx, normalizeText("Découvrez les idées partagées sur agôn - l'arène des idées"), 600, 380, 860, 38);
    ...
    ctx.font = "28px Arial";
    ctx.textAlign = "center";
    ctx.fillText(normalizeText("Comparez les arguments sur agôn - l'arène des idées"), 600, 590);
    ctx.textAlign = "left";
  }
