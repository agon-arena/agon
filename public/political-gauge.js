(function () {
  function initPoliticalGauge(debate, optionA, optionB) {
    ...
    panel.innerHTML = `
      ...
      <p class="political-gauge-subtitle">Cette jauge indique la répartition des idées selon l'axe politique de l’arène.</p>
      <div class="political-gauge-meter" aria-label="Jauge politique gauche droite">
