...
function showStatus(kind) {
  ...
  if (kind === "loading") {
    ...
    message.innerHTML = '<div style="width:min(100%,520px);box-sizing:border-box;padding:clamp(22px,5vw,34px);border:1px solid rgba(255,255,255,.2);border-radius:22px;background:linear-gradient(145deg,rgba(18,29,38,.88),rgba(27,42,52,.76));box-shadow:0 18px 48px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.08);">' +
      ...
      '<p style="margin:0;font:600 clamp(14px,2.9vw,16px)/1.5 Arial,Helvetica,sans-serif;color:#f2f6f8;text-shadow:0 1px 3px rgba(0,0,0,.72);">Commence la mémorisation en cliquant sur <span style="display:inline-block;margin:0 2px;padding:2px 8px;border:1px solid rgba(201,220,229,.4);border-radius:999px;background:rgba(201,220,229,.14);color:#ffffff;font-weight:800;">Apprentissage</span> (bandeau du bas)&nbsp;: ton réseau neuronal commencera sa formation.</p>' +
      '</div>';
