...
-- "Voltaire" liée à la fiche "Les Lumières"), détectés par l'IA lors de la première
-- bonne réponse qui ajoute réellement la connaissance à la mémoire de l'utilisateur
-- (cf. findAndStoreCultureGeneraleNotionLink, server.js). Une notion est
